...
| [TRAPS.md](TRAPS.md) | 101 durable traps — browser engines and WebGL, Node/pnpm, SQLite, numpy, Docker, this repo's shape. **Check here before debugging something that smells familiar.** |
