...
| [TRAPS.md](TRAPS.md) | 90 durable traps — browser engines, Node/pnpm, SQLite, numpy, Docker, this repo's shape. **Check here before debugging something that smells familiar.** |
