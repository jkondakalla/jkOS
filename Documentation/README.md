...
| [TRAPS.md](TRAPS.md) | 94 durable traps — browser engines, Node/pnpm, SQLite, numpy, Docker, this repo's shape. **Check here before debugging something that smells familiar.** |
