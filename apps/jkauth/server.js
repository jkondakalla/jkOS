...
function issueTokens(res, user) {
  ...
  run('INSERT INTO sessions (user_id, token_hash, expires_at) VALUES (?,?,?)', [user.id, refreshHash, expiresAt])
  ...
  res.cookie(REFRESH_COOKIE, refresh, { ...COOKIE_OPTS, maxAge: REFRESH_TTL_MS })
}
