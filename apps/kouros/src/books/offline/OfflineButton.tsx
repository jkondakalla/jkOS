import { TButton, cx } from '@jkos/ui';
...
// the book playable in-app with no network, which 7.3's SW then serves).
  ...
  if (status.phase === 'available') {
    return (
      <div className="offline-ctl">
        <TButton
          quiet
          className={cx('offline-ctl-btn', 'is-available')}
