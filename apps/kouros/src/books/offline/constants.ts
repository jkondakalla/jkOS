 ...
 *  (`kouros-shell-*`, public/sw.js) so shell eviction never drops a downloaded book
 *  and a book removal never touches the shell. */
export const MEDIA_CACHE = 'kouros-books-media-v1'   /* MUST match public/sw.js's BOOK_MEDIA_CACHE literal — the SW can't import this module */;

/** IndexedDB database name for offline bookkeeping. */
export const OFFLINE_DB = 'kouros-books-offline';
