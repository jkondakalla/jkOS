...
// the ADAPTER (how a queued write maps onto the progress/bookmarks
...
export const WRITE_QUEUE_DB = 'kouros-books-write-queue';
...
export function initOfflineWrites(direct: DirectWriteApi): QueuedWriteApi {
  /* ── The adapter: queued writes ⇄ the progress/bookmarks collection routes ──────────── */
