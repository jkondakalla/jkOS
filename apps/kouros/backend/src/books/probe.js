...
// re-exported here UNCHANGED so nothing importing them from `./probe`
// (books.probe.smoke.mjs, scan.js) had to change when the mapping moved. `parseProbe` stays pure (no I/O) there
