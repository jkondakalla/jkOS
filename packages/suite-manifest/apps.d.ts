...
export declare const APP_IDS: readonly ['auth', 'beigeboard', 'ordeck', 'staging', 'lazuros', 'papyros', 'kouros', 'jkdeploy'];
 ...
 *  paths derive from it unless an override pins them (LazurOS). */
