'use strict';
// discovery.js — __NAME__'s Weave discovery declarations, DERIVED from a collection.
//
...
// routes (server.js) AND these discovery docs — what can be DONE to __NAME__
...
/* Define __NAME__'s data type ONCE. Edit these fields to shape the app; everything
   downstream (table, create/update/delete capabilities, the items dataset) follows. */
const ITEMS = defineCollection({
  app: '__ID__', id: 'items', label: 'Items',
  fields: [
...
const CAPABILITIES = { app: '__ID__', version: 1, capabilities: ITEMS.capabilities };
const DATASETS = { app: '__ID__', version: 1, datasets: [ITEMS.dataset] };
